...
module.exports.register = function(req, res) {
	...
	user.save(function(err) {
		...
		if (err) {
			...
			var message = 'Hello ' + req.body.name + ',\n\n' + 'Welcome to chat. Please verify account and become our true customer. The verification link is right below, click it and you are all set.\n\n' +
				'http://' + req.headers.host + '/#/verify/' + linkToken + '\n\n\nSocketio chat Team';
			mailOptions = {
				from: 'harryac007@gmail.com', // sender address
				to: req.body.email, // list of receivers
				subject: 'Welcome to Socketio Chat', // Subject line
				text: message
